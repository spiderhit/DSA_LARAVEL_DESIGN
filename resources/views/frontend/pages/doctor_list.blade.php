                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <a class="category-carousel-item fl-wrap full-height checket-cat" href="#">
                                                        <img src="{{asset('front_ui')}}/images/all/12.jpg" alt="">
                                                ...
                                                <div class="swiper-slide">
                                                    <a class="category-carousel-item fl-wrap full-height" href="#">
                                                        <img src="{{asset('front_ui')}}/images/all/34.jpg" alt="">
                                                ...
                                                <div class="swiper-slide">
                                                    <a class="category-carousel-item fl-wrap full-height" href="#">
                                                        <img src="{{asset('front_ui')}}/images/all/33.jpg" alt="">
                                                ...
                                                <div class="swiper-slide">
                                                    <a class="category-carousel-item fl-wrap full-height" href="#">
                                                        <img src="{{asset('front_ui')}}/images/all/10.jpg" alt="">
                                                ...
                                                <div class="swiper-slide">
                                                    <a class="category-carousel-item fl-wrap full-height" href="#">
                                                        <img src="{{asset('front_ui')}}/images/all/11.jpg" alt="">
