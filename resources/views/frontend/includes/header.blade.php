<header class="main-header">
    <!-- logo-->
    <a href="index.html" class="logo-holder"><img src="{{asset('front_ui')}}/images/logo.png" alt="" width=""></a>
    <!-- logo end-->
    <!-- header-search_btn-->
    ...
    <div class="nav-holder main-menu">
        <nav>
            <ul class="no-list-style">
                <li>
                    <a href="{{url('/')}}" class="act-link">Home <i class="fa fa-caret-down"></i></a>
                    <!--second level -->
                    {{-- <ul>
    ...
    <div class="header-modal novis_wishlist">
        ...
        <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar="">
            ...
            <div class="widget-posts  fl-wrap">
                <ul class="no-list-style">
                    <li>
                        <div class="widget-posts-img"><a href="listing-single.html"><img src="{{asset('front_ui')}}/images/gallery/thumbnail/1.png" alt=""></a>
                        </div>
                    ...
                    <li>
                        <div class="widget-posts-img"><a href="listing-single.html"><img src="{{asset('front_ui')}}/images/gallery/thumbnail/2.png" alt=""></a>
                        </div>
                        <div class="widget-posts-descr">
                    ...
                    <li>
                        <div class="widget-posts-img"><a href="listing-single.html"><img src="{{asset('front_ui')}}/images/gallery/thumbnail/3.png" alt=""></a>
                        </div>
                        <div class="widget-posts-descr">
                    ...
                    <li>
                        <div class="widget-posts-img"><a href="listing-single.html"><img src="{{asset('front_ui')}}/images/gallery/thumbnail/4.png" alt=""></a>
                        </div>
                        <div class="widget-posts-descr">
